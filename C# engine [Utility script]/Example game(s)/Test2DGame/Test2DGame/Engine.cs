...
namespace Apollo
{
    ...
    public class Graphics
    {
        ...
        {
            public static System.Drawing.SolidBrush DrawingBrush = new System.Drawing.SolidBrush(System.Drawing.Color.Black);
            public static System.Drawing.Graphics GraphicsOut;
            public static void GraphicsInit(Form GameWindow)
            {
                GraphicsOut = GameWindow.CreateGraphics();
                GraphicsOut.Clear(Color.Black);
            }
            public virtual void DrawLoop(Form GameWindow) //this is called once per frame.
            {
